...
<div class="container">
  <div class="jumbotron jumbotron-fluid text-center">
    <div class="container">
        <h1 class="display-4">Hai, <?=ucfirst($online['name'])?></h1>
        ...
        <div class="col-md-4">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="http://localhost/rest_server_codeigniter/with_codeigniter/authentication/logout">Logout</a></li>
              </ol>
            </nav>
